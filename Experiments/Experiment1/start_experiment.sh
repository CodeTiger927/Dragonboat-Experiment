...
ssh -i ~/.ssh/id_rsa $username@"$s1" "sudo wget https://golang.org/dl/go1.16.5.linux-amd64.tar.gz && sudo rm -rf /usr/local/go && sudo tar -C /usr/local -xzf go1.16.5.linux-amd64.tar.gz && sudo git clone https://github.com/CodeTiger927/Dragonboat-Experiment.git && cd Dragonboat-Experiment"
ssh -i ~/.ssh/id_rsa $username@"$s1" "cd Dragonboat-Experiment && sudo /usr/local/go/bin/go build -o main . && sudo nohup ./main -nodeid 1 -addr1 $s1:63001 -addr2 $s2:63002 -addr3 $s3:63003 &"
ssh -i ~/.ssh/id_rsa $username@"$s2" "sudo wget https://golang.org/dl/go1.16.5.linux-amd64.tar.gz && sudo rm -rf /usr/local/go && sudo tar -C /usr/local -xzf go1.16.5.linux-amd64.tar.gz && sudo git clone https://github.com/CodeTiger927/Dragonboat-Experiment.git && cd Dragonboat-Experiment"
ssh -i ~/.ssh/id_rsa $username@"$s2" "cd Dragonboat-Experiment && sudo /usr/local/go/bin/go build -o main . && sudo nohup ./main -nodeid 2 -addr1 $s1:63001 -addr2 $s2:63002 -addr3 $s3:63003 &"
ssh -i ~/.ssh/id_rsa $username@"$s3" "sudo wget https://golang.org/dl/go1.16.5.linux-amd64.tar.gz && sudo rm -rf /usr/local/go && sudo tar -C /usr/local -xzf go1.16.5.linux-amd64.tar.gz && sudo git clone https://github.com/CodeTiger927/Dragonboat-Experiment.git && cd Dragonboat-Experiment"
ssh -i ~/.ssh/id_rsa $username@"$s3" "cd Dragonboat-Experiment && sudo /usr/local/go/bin/go build -o main . && sudo nohup ./main -nodeid 3 -addr1 $s1:63001 -addr2 $s2:63002 -addr3 $s3:63003 &"
sleep 50
